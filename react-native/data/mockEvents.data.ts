...
export const mockEvents: Event[] = [
  ...
  },
  {
    ...
    images: [{ src: "https://images.unsplash.com/photo-1519389950473-47ba0277781c", likes: 0 }],
    prompts: [
      { prompt: "What tech trend excites you?", answer: "AI and machine learning.", likes: 0 },
      { prompt: "Would you present at a conference?", answer: "Yes, if I had something innovative.", likes: 0 },
    ],
    interestedCount: 980,
  },
]
