        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Format = table.Column<string>(type: "character varying(16)", maxLength: 16, nullable: false, defaultValue: "inperson"),
                    StartAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    EndAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    Access_Instruction = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                    Access_Password = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    Attendance_Interested = table.Column<int>(type: "integer", nullable: true),
                    Attendance_Going = table.Column<int>(type: "integer", nullable: true),
                    Attendance_CheckedIn = table.Column<int>(type: "integer", nullable: true),
                    AgeRestriction = table.Column<int>(type: "integer", nullable: true),
                    Themes = table.Column<List<string>>(type: "text[]", nullable: true),
                    Sections = table.Column<JsonDocument>(type: "jsonb", nullable: true),
